         SUBROUTINE i_h2_model(Q2,W2,SIG_NRES,SIG_RES1,SIG_RES2,
     >                    sigroper,goroper)
********************************************************************************
*
* This subroutine calculates model cross sections for neutron in resonance region. 
* Cross section is returned in nanobarns. 
* For the second and third resonance regions we use nonrelativistc
* Breit-Wigner shapes (L.Stuart). 
* For the Delta, we use more complicated formulae (P.Stoler) 
...
*
	...
	data Mn/0.938/
      Am2 = Am*Am
*
* parametrii de fitat se cheama XVAL (asa ii recunoaste Minuit)
* aici ii translatam in vectorii pe care ii intelege modelu'
*
      do i=1,3
         mass(i)  = XVALH(i+1)
*         write(*,*)xvalh(i)
...
*
* gata cu reasignarea parametrilor
*
...
*      sigma_delta = beta_pi*Mass(1)*Mass(1)*gamma_gamma*gamma_pi/
*     >              denom_pi
      sigma_delta  = 389.4*2.*pi*alpha*W/Am*Krcm/kcm
     >   *Q2/K*gamma_gamma*gamma_pi/width(1)/denom_pi
* For the second and third resonance regions, put in BW shape:
...
*      write(*,*)'iuhu 5'
*
* Now put in the Q2 dependence of AH(Q2):
