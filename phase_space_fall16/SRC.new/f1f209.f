...
c 
      Subroutine f1f209(z,a,q2,w2,f1,f2)

      implicit none
      real*8 q2,w2,F1,F2,F1in,F2in,F1qe,F2qe,rin,rqe
      real*8 z,a,nu,x,am/0.9383/

      call F1F2IN09(z,a,q2,w2,F1in,F2in)
...
cc        do ism = 1,99
cc          fyuse = fyp(ism)/100.
cc          WSQP = WSQ + XXp(ISM) * PF * DW2DPF - es * dw2des
